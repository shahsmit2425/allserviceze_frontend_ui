...
function AuthField({ id, label, icon: Icon, hint, className, inputClassName, ...props }) {
  return (
    <div className={cn("space-y-2.5", className)}>
      <Label htmlFor={id} className="text-sm font-semibold text-teal-700 block" style={{ fontFamily: "'Lora', serif" }}>{label}</Label>
      <div className="relative">
        {Icon ? <Icon className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400" /> : null}
        <Input id={id} className={cn("h-12 rounded-xl border border-teal-300 bg-white text-sm text-teal-900 placeholder:text-slate-400 transition-all focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-none", Icon ? "pl-12" : "pl-4", inputClassName)} {...props} />
      </div>
    ...
    return (
      <main className="min-h-screen bg-transparent">
        ...
        <div className="page-shell safe-top-shell safe-bottom-shell py-4 sm:py-6">
          ...
          <section className="hidden lg:flex flex-col justify-center bg-gradient-to-br from-slate-50 via-amber-50/30 to-white p-14 relative overflow-hidden border-l border-teal-200">
            {/* Subtle decorative elements */}
            <div className="absolute top-0 right-0 w-80 h-80 bg-amber-100/8 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-72 h-72 bg-teal-200/5 rounded-full blur-3xl" />
            
            <div className="relative z-10 max-w-lg">
              <div className="mb-14">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-100 rounded-full mb-6 border border-teal-200">
                  <span className="w-2 h-2 rounded-full bg-teal-900" />
                  <span className="text-teal-700 text-sm font-semibold" style={{ fontFamily: "'Lora', serif" }}>Why ServiceTones</span>
                </div>
                <h2 className="text-4xl font-bold mb-4 text-teal-900" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Build Trust, Together
                </h2>
                <p className="text-teal-600 text-lg leading-relaxed" style={{ fontFamily: "'Lora', serif" }}>
                ...
                {[
                  ...
                  <div key={idx} className="flex gap-4 group">
                    <div className="flex-shrink-0 mt-1">
                      <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-teal-200 text-teal-700 font-bold text-sm group-hover:bg-teal-300 transition-colors">
                        {item.icon}
                      </div>
                    </div>
                    <div>
                      <h3 className="font-semibold text-teal-900 mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>{item.title}</h3>
                      <p className="text-teal-600 text-sm" style={{ fontFamily: "'Lora', serif" }}>{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>

              <div className="mt-14 pt-8 border-t border-teal-200">
                <div className="grid grid-cols-3 gap-6">
                  <div>
                    <div className="text-3xl font-bold text-teal-900 mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>15K+</div>
                    <p className="text-teal-600 text-sm" style={{ fontFamily: "'Lora', serif" }}>Verified Professionals</p>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-teal-900 mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>25K+</div>
                    <p className="text-teal-600 text-sm" style={{ fontFamily: "'Lora', serif" }}>Projects Completed</p>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-teal-900 mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>4.8★</div>
                    <p className="text-teal-600 text-sm" style={{ fontFamily: "'Lora', serif" }}>Average Rating</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <main className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-slate-50" style={{ fontFamily: "'Georgia', 'Garamond', serif" }}>
      ...
      <div className="min-h-screen flex items-center justify-center py-8">
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden shadow-2xl">
          {/* Left Panel - Image */}
          <section className="hidden lg:flex flex-col justify-center items-center bg-gradient-to-br from-teal-900 via-teal-800 to-teal-900 p-12 relative overflow-hidden">
              ...
              <Tabs value={activeTab} onValueChange={handleTabChange}>
                ...
                <TabsContent value="login" className="mt-0">
                  <div className="space-y-3 mb-8">
                    <h1 className="text-5xl font-bold text-teal-900" style={{ fontFamily: "'Playfair Display', serif" }}>
                      Welcome Back
                    </h1>
                    ...
                    <Card className="border border-teal-200 bg-white shadow-lg rounded-2xl">
                      <CardContent className="p-6 sm:p-8">
                        ...
                        <Button
                          type="submit"
                          className="w-full rounded-xl py-3 bg-gradient-to-r from-teal-900 to-teal-800 text-white font-semibold hover:from-teal-800 hover:to-teal-700 transition-all shadow-md hover:shadow-lg mt-6"
                          disabled={loading}
                        ...
                        >
                          ...
                          <p className="text-sm text-teal-600">
                            New to ServiceTones?{" "}
                            <button type="button" onClick={() => handleTabChange("register")} className="font-semibold text-teal-900 hover:underline">
                              Register
                            </button>
                          </p>
                        </div>
                ...
                <TabsContent value="register" className="mt-0">
                  <div className="space-y-3 mb-8">
                    ...
                    <p className="text-sm text-teal-600">
                      ...
                      <button type="button" onClick={() => handleTabChange("login")} className="font-semibold text-teal-900 hover:underline">
                        Sign in
                      </button>
                    </p>
                </TabsContent>
