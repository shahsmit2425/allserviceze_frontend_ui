        ...
        <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <section className="page-hero h-full">
            <div className="max-w-xl">
              ...
              {email && (
                <div className="mt-6 rounded-lg border border-white/70 bg-white/70 px-4 py-3 text-sm font-medium text-foreground shadow-sm shadow-teal-900/5">
                  {email}
                </div>
              )}
            </div>
          ...
          <Card className="w-full overflow-hidden rounded-xl border border-white/70 bg-white/88 shadow-xl shadow-teal-900/5 backdrop-blur-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup value={role} onValueChange={setRole} className="grid gap-3 sm:grid-cols-2">
                    <label htmlFor="role_customer" className="flex cursor-pointer items-center gap-3 rounded-lg border border-teal-200/80 bg-slate-50/80 px-4 py-4">
                      <RadioGroupItem value="customer" id="role_customer" />
                      <span className="text-sm font-medium text-foreground">Customer</span>
                    </label>
                    <label htmlFor="role_provider" className="flex cursor-pointer items-center gap-3 rounded-lg border border-teal-200/80 bg-slate-50/80 px-4 py-4">
