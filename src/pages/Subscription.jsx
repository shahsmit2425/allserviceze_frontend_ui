  ...
  return (
    ...
    >
      <div className="page-shell space-y-6 py-8">
        ...
        {user?.role === "provider" && usage && (
          <section className="rounded-xl border border-white/70 bg-white/82 p-5 shadow-xl shadow-teal-900/5 backdrop-blur-xl sm:p-6">
            ...
            <div className="mt-5 grid gap-4 lg:grid-cols-[1.3fr_0.8fr]">
              <div className="rounded-lg border border-teal-200/80 bg-slate-50/80 p-5">
        ...
        <section className="grid gap-5 lg:grid-cols-3">
          {plans.map((plan) => {
            ...
            return (
              <Card
                key={plan.id}
                className={`relative overflow-hidden rounded-xl border-2 bg-white/88 shadow-xl shadow-teal-900/5 backdrop-blur-sm ${planColors[plan.id]} ${isPopular ? "lg:-translate-y-2" : ""}`}
              >
                {isPopular && (
        ...
        <section className="rounded-xl border border-white/70 bg-white/82 p-5 shadow-xl shadow-teal-900/5 backdrop-blur-xl sm:p-6">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <Card className="rounded-lg border border-teal-200/80 bg-slate-50/80 shadow-none">
