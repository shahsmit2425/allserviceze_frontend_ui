        ...
        <PopoverContent className="w-[23rem] overflow-hidden rounded-[1.5rem] border border-border/70 bg-popover/95 p-0 shadow-xl shadow-slate-950/30 backdrop-blur-xl" align="end">
          <div className="flex items-center justify-between border-b border-border/70 bg-muted/45 p-4">
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-primary/10 text-primary shadow-sm shadow-deep-navy-800/5">
          ...
          <ScrollArea className="h-80">
            {notifications.length > 0 ? (
                ...
                {notifications.map((notification) => (
                  ...
                  >
                    <div className="flex gap-3">
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-muted/60 text-xl shadow-sm shadow-deep-navy-800/5">
                      ...
                      {!notification.read && (
                        <div className="mt-2 h-2.5 w-2.5 rounded-full bg-primary shadow-sm shadow-deep-navy-800/10" />
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="flex h-full flex-col items-center justify-center py-10 text-center text-muted-foreground">
                <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-[1.35rem] bg-muted/60 shadow-sm shadow-deep-navy-800/5">
