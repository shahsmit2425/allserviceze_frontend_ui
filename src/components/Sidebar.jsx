...
const SidebarLink = ({ to, icon: Icon, label, isActive, onClick }) => (
  <Link
    ...
    className={cn(
      ...
      isActive
        ? "bg-gradient-to-r from-amber-600/10 to-amber-600/5 text-slate-900 shadow-sm border border-amber-600/30"
          ...
          <div className="border-b border-slate-200 px-4 py-3 sm:px-5">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="w-full rounded-lg border border-slate-300 bg-white pl-9 pr-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 transition-colors focus:border-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-600/20"
              />
            </div>
          </div>
        )}
