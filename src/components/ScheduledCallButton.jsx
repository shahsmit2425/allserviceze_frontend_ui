    ...
    <>
      <div className="info-tile space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {presenceCount > 0 && (
            <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-400/20 bg-background/80 px-3 py-2 text-xs font-semibold text-emerald-100 shadow-sm shadow-deep-navy-800/5">
