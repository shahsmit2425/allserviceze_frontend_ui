...
const STATUS_STYLES = {
  pending:   { bg: "border border-amber-400/30 bg-amber-500/14 text-amber-100", dot: "bg-amber-300" },
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 mt-3 text-xs text-muted-foreground justify-center flex-wrap">
                ...
                <span className="flex items-center gap-1">
                  <span className="w-2 h-2 rounded-full bg-amber-400 inline-block" /> Partial block
                </span>
                        ...
                        <div
                          ...
                          className={`flex items-start justify-between rounded-lg p-3 border ${
                            blk.is_full_day !== false
                              ...
                              : "border-amber-400/28 bg-amber-500/12"
                          }`}
                        >
                          <div>
                            <p className={`font-medium text-sm flex items-center gap-1.5 ${
                              blk.is_full_day !== false ? "text-rose-200" : "text-amber-200"
                            }`}>
