      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, idx) => {
            ...
            return (
              <div key={idx} className="group p-8 rounded-2xl border border-teal-200 hover:border-primary hover:shadow-lg transition-all duration-300 bg-white hover:bg-slate-50">
