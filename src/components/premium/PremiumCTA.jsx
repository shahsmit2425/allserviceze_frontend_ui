...
export function PremiumCTA({ 
  ...
  return (
    <section className={`py-20 md:py-28 ${isDark ? "bg-gradient-to-r from-teal-900 to-teal-800 text-white" : "bg-gradient-to-r from-amber-50 to-slate-50"}`}>
      {/* Decorative elements */}
      {isDark && (
        <>
      ...
      <div className={`relative z-10 max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 text-center`}>
        <h2 
          className={`text-4xl md:text-5xl font-bold mb-6 ${isDark ? "text-white" : "text-teal-900"}`}
        ...
        {description && (
          <p 
            className={`text-lg md:text-xl mb-10 max-w-2xl mx-auto ${isDark ? "text-teal-200" : "text-teal-600"}`}
